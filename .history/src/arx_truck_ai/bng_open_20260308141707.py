...
class TruckTrailer:
    ...
    def set_sensors(self):
        ...
        self.imu_trailer = AdvancedIMU(
            ...
            pos=(0, 1.765, 0.877), dir=(-1, 0, 0), up=(0, 0, 1), # Ajustado al techo del tráiler
        ...
        self.front_cam = Camera(
            ...
            pos=(0, -0.394, 0.7), dir=(1, 0, 0), resolution=(320, 180)
        )
        ...
        self.reverse_cam = Camera(
            ...
            pos=(0.0, 9.150, 0.876), dir=(-1, 0.0, 0), resolution=(640, 360)
        )
        ...
        self.lidar_front = Lidar(
            ...
            pos=(0, 0.0178, 2.784),
            dir=(1, 0, 0.0),        # Apuntando hacia adelante (Eje -Y en BeamNG)
            up=(0.0, 0.0, 1.0),
        ...
        self.lidar_rear = Lidar(
            ...
            pos=(0.0, 9.148, 3.960),
            dir=(-1, 0, 0.0),         # Apuntando hacia atrás (Eje +Y en BeamNG)
            up=(0.0, 0.0, 1.0),
            vertical_resolution=16, frequency=20, is_visualised=False
        )
