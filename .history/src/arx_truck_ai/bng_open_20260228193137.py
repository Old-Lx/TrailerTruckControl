...
def main():
    ...
    scenario = Scenario("tech_ground", "Test Land", description="Implementación de un modelo de control para truck trailer") # tech_ground o autotest son los más despejados
    ...
    orig = (-50, -200, 0) # x = -50, y = -200, z = 0 Para un buen punto en autotest con el camión
    trailer_orig = (-50, -206.5, 0)

    # Add it to our scenario at this position and rotation
    scenario.add_vehicle(truck, pos=orig, rot_quat=(0, 0, 10, 0))
