...
def main():
    ...
    truck_configs = available_vehicles['vehicles']['cargotrailer']['configurations']
    ...
    trailer_cargo_configs = available_vehicles['vehicles']['us_semi']['configurations']
    trailer_cargo_base_cfg = trailer_cargo_configs['tc82_base'] 
    trailer_cargo_cfg_path = f"vehicles/us_semi/{trailer_cargo_base_cfg['key']}.pc" # La f crea una formatted string, similar a lo que se hace en C
