...
def main():
    ...
    trailer_cargo_configs = available_vehicles['vehicles']['cargotrailer']['configurations']
    trailer_cargo_base_cfg = trailer_cargo_configs['loaded_planks'] 
    trailer_cargo_cfg_path = f"vehicles/cargotrailer/{trailer_cargo_base_cfg['key']}.pc" # La f crea una formatted string, similar a lo que se hace en C
