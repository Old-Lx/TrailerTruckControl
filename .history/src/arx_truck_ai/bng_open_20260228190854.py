...
def main():
    ...
    trailer_configs = available_vehicles['vehicles']['tsfb']['configurations']
    trailer_base_cfg = trailer_configs['loaded_planks'] 
    trailer_cfg_path = f"vehicles/tsfb/{trailer_base_cfg['key']}.pc" # La f crea una formatted string, similar a lo que se hace en C
    ...
    trailer = Vehicle('trailer', model='tsfb', license='Lartrax', part_config=trailer_cfg_path)
