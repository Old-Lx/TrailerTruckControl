...
def main():
    ...
    pc_route = getenv('TRUCK_PART_CONFIG_ROUTE')
    ...
    configs = available_vehicles['vehicles']['us_semi']['configurations']
    base_cfg = configs['tc82_base'] 
    truck_cfg_path = f"vehicles/us_semi/{base_cfg['key']}.pc" # La f crea una formatted string, similar a lo que se hace en C
