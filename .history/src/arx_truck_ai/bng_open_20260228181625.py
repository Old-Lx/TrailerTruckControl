...
def main():
    ...
    truck_entry = available['vehicles']['us_semi']
    base_cfg = truck_entry['configurations']['tc82_base']
    truck_cfg_path = base_cfg['config']
    print(truck_cfg_path)
    ...
    truck = Vehicle('truck', model='us_semi', license='Lartrax', part_config=truck_cfg)
