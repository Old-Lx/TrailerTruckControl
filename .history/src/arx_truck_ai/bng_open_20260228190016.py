...
def main():
    ...
    trailer_configs = available_vehicles['vehicles']['cargotrailer']['configurations']
    trailer_base_cfg = trailer_configs['loaded_planks'] 
    trailer_cfg_path = f"vehicles/cargotrailer/{trailer_base_cfg['key']}.pc" # La f crea una formatted string, similar a lo que se hace en C
    ...
    trailer = Vehicle('trailer', model='cargoTrailer', license='Lartrax', part_config=trailer_cfg_path)

    orig = (-50, -400, 0.5) # x = -50, y = -200, z = 0 Para un buen punto en autotest con el camión
    trailer_orig = (-50, -406.5, 0)
