...
def main():
    ...
    # Coincidencias que contienen 'semi' explícito
    semi_like = [k for k in vehicles if 'semi' in k.lower()]
    print(semi_like)  # ['cargotrailer', 'containerTrailer', 'us_semi', ...]

    # O sólo los que comienzan con 't' (t-series, tanker, etc.)
    t_series_like = [k for k in vehicles if k.lower().startswith('t')]
    print(t_series_like)
